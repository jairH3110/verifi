...
# Quick-start development settings s- unsuitable for TESTuction
# See https://docs.djangoproject.com/en/3.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in TESTuction secret!
#SECRET_KEY = 'yu%#5l#)w7r=su50-^nmaxw=!@7%0yer1@%(7+p*qocvy78i$i'
SECRET_KEY = config("TEST_SECRET_KEY", default='')
# SECURITY WARNING: don't run with debug turned on in TESTuction!
DEBUG = True
